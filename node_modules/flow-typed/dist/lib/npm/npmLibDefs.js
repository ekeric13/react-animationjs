    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          _context2.next = 14;
          return regeneratorRuntime.awrap(_npmExists(pkgName).then().catch(function (error) {
            // Only fail spen on 404, not on timeout
            if (error.statusCode === 404) {
              var pkgError = 'Package does not exist on npm!';
              (0, _validationErrors.validationError)(pkgName, pkgError, validationErrors);
            }
          }));
  ...
  return regeneratorRuntime.async(function _npmExists$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          pkgUrl = 'https://www.npmjs.org/package/' + pkgName;
