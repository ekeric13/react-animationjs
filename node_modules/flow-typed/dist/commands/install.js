...
function run(args) {
  var cwd, packageDir, flowVersion, libdefDir, explicitLibDefs, ignoreDeps, coreLibDefResult, npmLibDefResult;
...
function installNpmLibDefs(_ref) {
  ...
  var flowProjectRoot, libdefsToSearchFor, i, term, termMatches, _termMatches, _2, npmScope, pkgName, pkgVerStr, scopedPkgName, pkgJsonData, pkgJsonDeps, libDefsToSearchForEntries, libDefsToInstall, outdatedLibDefsToInstall, unavailableLibDefs, libDefsToUninstall, alreadyInstalledLibDefs, flowTypedDirPath, results, untypedMissingLibDefs, typedMissingLibDefs, plural;
    ...
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 26:
          ...
          pkgJsonDeps = (0, _npmProjectUtils.getPackageJsonDependencies)(pkgJsonData, ignoreDeps);
            ...
            return regeneratorRuntime.async(function _callee4$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    _context7.next = 2;
                    return regeneratorRuntime.awrap((0, _stubUtils.createStub)(flowProjectRoot, pkgName, pkgVerStr, true /*ovewrite*/
                    , libdefDir));
