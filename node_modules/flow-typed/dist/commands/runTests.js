 ...
 * directory.
 */
var basePathRegex = new RegExp('definitions' + _node.path.sep + 'npm' + _node.path.sep + '[^' + _node.path.sep + ']*' + _node.path.sep + '?');
...
function runTestGroup(testGroup) {
  ...
  return regeneratorRuntime.async(function runTestGroup$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 10:
          orderedFlowVersions = _context9.sent;
          _context9.next = 18;
          break;
  ...
  return regeneratorRuntime.async(function runTests$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 3:
          _context10.t0 = function (testGroup) {
          ...
          testGroups = _context10.sent.filter(_context10.t0);
          _context10.prev = 5;
          _context10.next = 8;
        ...
        case 18:
          testGroupErrors = _context10.sent;
...
function run(argv) {
  var testPatterns, onlyChanged, cwd, cwdDefsNPMPath, repoDirPath, results;
    ...
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 9:
          ...
          _context11.t0 = cwdDefsNPMPath;
          _context11.next = 14;
          break;

        case 13:
          _context11.t0 = _node.path.join(__dirname, '..', '..', '..', 'definitions', 'npm');

        case 14:
          repoDirPath = _context11.t0;
